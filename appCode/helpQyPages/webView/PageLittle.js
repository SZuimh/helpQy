...
export default class PageLittle extends Component {
    constructor(props) {
        super(props);
        this.state = {
            display: 'none',
    ...
    getSumInfo(){
        ...
        formData.append('helptype','little');
        let option = {
            url: UrlGetSumInfo,
            body: formData
        };
    ...
    goHuzhuGongyue(){
        this.props.navigation.navigate("PageRulesLittle",{
                        ...
                        <View style={styles.HeaderView}>
                            <View style={styles.PlansAndImage}>
                                <View style={styles.HeaderPlans}>
                                    <Text style={styles.PlansTitle}>少儿大病互助</Text>
                                    <Text style={styles.PlansHeaderFont}>最高获配30万元互助金</Text>
                                    <Text style={styles.PlansHeaderFont}>互助事件：173</Text>
                                </View>
                                <View>
                                    <Image source={require('../img/children.png')} style={styles.HeaderImage}/>
                                </View>
                            </View>
