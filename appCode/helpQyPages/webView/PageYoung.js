...
export default class PageYoung extends Component {
    constructor(props) {
        super(props);
        this.state = {
            display: 'none',
    ...
    getSumInfo(){
        ...
        formData.append('helptype','young');
        let option = {
            url: UrlGetSumInfo,
            body: formData
        };
    ...
    goHuzhuGongyue(){
        this.props.navigation.navigate("PageRulesYoung",{
                        ...
                        <View style={styles.HeaderView}>
                            <View style={styles.PlansAndImage}>
                                <View style={styles.HeaderPlans}>
                                    <Text style={styles.PlansTitle}>中青年抗癌互助</Text>
                                    <Text style={styles.PlansHeaderFont}>最高获配30万元互助金</Text>
                                    <Text style={styles.PlansHeaderFont}>互助事件：173</Text>
                                </View>
                                <View>
                                    <Image source={require('../img/zhongqingnian.png')} style={styles.HeaderImage}/>
                                </View>
                            </View>
