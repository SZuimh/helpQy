...
export default class PageQiyeZonghe extends Component {
    constructor(props) {
        super(props);
        this.state = {
            display: 'none',
    ...
    goHuzhuGongyue(){
        this.props.navigation.navigate("PageRulesQiyeZonghe",{
                        ...
                        <View style={styles.HeaderView}>
                            <View style={styles.PlansAndImage}>
                                <View style={styles.HeaderPlans}>
                                    <Text style={styles.PlansTitle}>企业员工综合意外互助</Text>
                                    <Text style={styles.PlansHeaderFont}>最高获配30万元互助金</Text>
                                    <Text style={styles.PlansHeaderFont}>互助事件：173</Text>
                                </View>
                                <View>
                                    <Image source={require('../img/zongheyiwai.png')} style={styles.HeaderImage}/>
                                </View>
                            </View>
