...
export default class PageOld extends Component {
    constructor(props) {
        super(props);
        this.state = {
            display: 'none',
    ...
    goHuzhuGongyue(){
        this.props.navigation.navigate("PageRulesOld",{
                        ...
                        <View style={styles.HeaderView}>
                            <View style={styles.PlansAndImage}>
                                <View style={styles.HeaderPlans}>
                                    <Text style={styles.PlansTitle}>中老年抗癌互助</Text>
                                    <Text style={styles.PlansHeaderFont}>最高获配30万元互助金</Text>
                                    <Text style={styles.PlansHeaderFont}>互助事件：173</Text>
                                </View>
                                <View>
                                    <Image source={require('../img/old.png')} style={styles.HeaderImage}/>
                                </View>
                            </View>
