...
export default class PagePlansQiyeDabing extends Component {
    constructor(props) {
        super(props);
        this.state = {
            display: 'none',
    ...
    goHuzhuGongyue(){
        this.props.navigation.navigate("PageHuzhuGongyue",{
                        ...
                        <View style={styles.HeaderView}>
                            <View style={styles.PlansAndImage}>
                                <View style={styles.HeaderPlans}>
                                    <Text style={styles.PlansTitle}>企业员工大病互助</Text>
                                    <Text style={styles.PlansHeaderFont}>最高获配30万元互助金</Text>
                                    <Text style={styles.PlansHeaderFont}>互助事件：173</Text>
                                </View>
                                <View>
                                    <Image source={require('./img/QiyeDabing.png')} style={styles.HeaderImage}/>
                                </View>
                            </View>
                            <View style={styles.PlansMoneyAndPeopleNumberView}>
                                <View style={styles.PlansMoneyAndPeopleNumber}>
                                    ...
                                    <Text style={[styles.PlansMoneyNumber, {color: '#e0b876'}]}>1723456.00</Text>
                                </View>
                                <View style={styles.PlansMoneyAndPeopleNumber}>
                                    <Text style={styles.PlansMoneyNumber}>加入员工(人)</Text>
                                    <Text style={[styles.PlansMoneyNumber, {color: '#e0b876'}]}>1724151</Text>
                                </View>
                                <View style={styles.PlansMoneyAndPeopleNumber}>
                                    <Text style={styles.PlansMoneyNumber}>救助均摊金额(元)</Text>
                                    <Text style={[styles.PlansMoneyNumber, {color: '#e0b876'}]}>0.04</Text>
                                </View>
                            </View>
                        </View>
