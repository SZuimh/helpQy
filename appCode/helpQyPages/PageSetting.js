    ...
    render(){
        return(
            <View style={styles.container}>
                ...
                <TouchableOpacity onPress={this.changeModalVisible.bind(this,!this.state.modalVisible)} style={styles.commonStyle}>
                    <Text >修改昵称</Text>
                    ...
                    <View style={styles.PageSettingChanegNameModal}>
                        <View style={styles.PageSettingChanegNameView}>
                            <View style={styles.PageSettingChanegNameButtonView}>
                                <Text style={{fontSize: 12, fontWeight: 'bold'}}>用户名</Text>
                            </View>
                            ...
                            <View style={{height:80,flexDirection:'column',alignItems:'center'}}>
                                ...
                                />
                                <Text style={{marginTop:10,fontSize:10,color:'red'}}>{this.state.errMsg}</Text>
                            </View>
                            <View style={styles.PageSettingChanegNameButtonView}>
